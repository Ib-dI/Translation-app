...
export const lessons = [
	...
	},
	{
		...
		description: "Les habitudes sont présent dans notre quotidient alors de quoi il sagit",
		content: [
			{
				type: "text",
				value:
	...
	},
	{
		...
		description: "Décrire un objet, une personne on ne peut se passer de l'incontournable adjectif.",
		content: [
			{
				type: "table",
				value: {
	...
	},
	{
		...
		description: "Similaire aux adjectifs les démonstratifs sont indispensables",
		content: [
			{
				type: "text",
	...
	},
	{
		...
		description: "Après cette partie on peut dire vous serrez un pro de la distinction du singulier/pluriel",
		content: [
			{
				type: "text",
				value:
	...
	},
	{
		...
		content: [
			...
			{
				type: "text",
				value: "(4) Cas des verbes monosyllabiques : suffixe -IWA ou -OLWA :",
			},
			{
				type: "text",
				value: "REMARQUE :",
